...
namespace yii\apidoc\templates\agentcars;
...
class ApiRenderer extends \yii\apidoc\templates\html\ApiRenderer
{
    ...
    public $layout = '@yii/apidoc/templates/agentcars/layouts/api.php';
    public $indexView = '@yii/apidoc/templates/agentcars/views/index.php';
